...
class DetailContentsTable extends Component {
  render() {
    ...
    const { state, model, rightSize, leftSize, last, sole, midsole, sockLining, heel, decoration, material, innerMaterial, color, detail, images } = this.props;
      ...
      <div className="detail-contents-table-wrapper">
        <div className="detail-contents-table">
          <div className="detail-contents-row">
            <div className="detail-contents-cell">모델</div>
            <div className="detail-contents-cell">{model}</div>
          </div>
          <div className="detail-contents-row">
            <div className="detail-contents-cell">라스트</div>
            <div className="detail-contents-cell">{last}</div>
          </div>
          <div className="detail-contents-row">
            <div className="detail-contents-cell">창</div>
            <div className="detail-contents-cell">{sole}</div>
          </div>
          <div className="detail-contents-row">
            <div className="detail-contents-cell">중창</div>
            <div className="detail-contents-cell">{midsole}</div>
          </div>
          <div className="detail-contents-row">
            <div className="detail-contents-cell">굽</div>
            <div className="detail-contents-cell">{heel}</div>
          </div>
          <div className="detail-contents-row">
            <div className="detail-contents-cell">까래</div>
            <div className="detail-contents-cell">{sockLining}</div>
          </div>
          <div className="detail-contents-row">
            <div className="detail-contents-cell">갑피</div>
            <div className="detail-contents-cell">{material}</div>
          </div>
          <div className="detail-contents-row">
            <div className="detail-contents-cell">내피</div>
            <div className="detail-contents-cell">{innerMaterial}</div>
          </div>
          <div className="detail-contents-row">
            <div className="detail-contents-cell">색상</div>
            <div className="detail-contents-cell">{color}</div>
          </div>
          <div className="detail-contents-row">
            <div className="detail-contents-cell">장식</div>
            <div className="detail-contents-cell">{decoration}</div>
          </div>
          <div className="detail-contents-row">
            <div className="detail-contents-cell">왼발사이즈</div>
            <div className="detail-contents-cell">{leftSize}</div>
          </div>
          <div className="detail-contents-row">
            <div className="detail-contents-cell">오른발사이즈</div>
            <div className="detail-contents-cell">{rightSize}</div>
          </div>
        </div>
        <div className="detail-contents-table-line"></div>
        <div className="detail-contents-row">
          <div className="detail-contents-cell">특이사항</div>
        </div>
        <div className="detail-contents-comment-row">
